...
public class C04_TotoFormTesti {
	@Test
	public void formTesti(){
		...
		List<WebElement> ayDropdownTumElementler =  selectAy.getOptions();
		System.out.println(ReusableMethods.stringListeCevir(ayDropdownTumElementler));

		Assert.assertEquals(ayDropdownTumElementler.size(),13);
